...
#dataset_type es la clase que se encuentra en los dataset
#data_source_cfg en type es el datasource 
data_source_cfg = dict(
    type='InteraccionList',
    memcached=True,
    mclient_path='/mnt/lustre/share/memcached_client')
data_train_list = 'data/elors/meta/train.txt'
data_train_root = 'data/elors/train'
dataset_type = 'DeepElorsDataset'
